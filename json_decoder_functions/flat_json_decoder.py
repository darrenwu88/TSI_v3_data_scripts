...
Converts flat telemtry json to .csv format using pd.json_normalize library function
...
json_filename = 'c50fv8u7kn8vcc9cd6cg_2022-12-02T15:00:00Z_2022-12-03T15:00:00Z.json'
...
def flatten_json(json_filename):
    ...
    raw_df.to_csv(os.path.join(r'./flat_telemetry_csv_lvl_0', f'{json_filename}.csv'), index = False)
