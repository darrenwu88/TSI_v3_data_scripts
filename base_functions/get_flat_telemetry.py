...
def get_telemetry_flat(token, device_id, start_date, end_date):
  ...
  with open(os.path.join(r'./flat_telemetry_jsons', f'{device_id}_{start_date}_{end_date}.json'), "w") as outfile:
